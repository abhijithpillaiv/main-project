...
export default function foodrec() {
    ...
    useEffect(() => {
        if(rec){
        if (rec.value&&rec.value.includes('_')) {
            setblg(rec.value.replace(/_/g, " "));
          }else{
            setblg(rec.value)
        }
          }
                ...
                <div className='row'>
                    <div style={{ textAlign: 'center' }} className="col-lg-7 col-sm-12">
                        ...
                        <div style={{ padding: '10px' }}>
                            ...
                            <br />
                            <div >
                                {blg?<Link to={`/blog/${blg}`} className='btn btn-success'>Get Recipe</Link>
                    ...
                    <div style={{ textAlign: 'center' }} className="col-lg-5 col-sm-12">
                        ...
                        <span style={{fontSize:'20px',fontWeight:'bold',color:'green',textDecoration:'underline'}}>{rec?rec.value?rec.value:rec:null}</span>
